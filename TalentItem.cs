...
namespace Rawr
{
    public class TalentItem
    {
        ...
        private Image _icon;
        //private void UpdateIcon() { _icon = ItemIcons.GetTalentIcon(_talentTree.CharacterClass, _talentTree.TreeName, _talentName + (_currentRank == 0 ? "-off" : ""), (_currentRank == 0 ? "grey/" : "") + _iconName + ".jpg"); } //Removed + ".jpg" due to duplicate issue.
        private void UpdateIcon() { _icon = ItemIcons.GetTalentIcon(_talentTree.CharacterClass, _talentTree.TreeName, _talentName + (_currentRank == 0 ? "" : ""), (_currentRank == 0 ? "" : "") + _iconName + ".jpg"); } //Removed + ".jpg" due to duplicate issue.
