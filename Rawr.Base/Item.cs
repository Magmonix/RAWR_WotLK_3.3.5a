...
namespace Rawr
{
	...
	public class Item : IComparable<Item>
	{
        ...
        public static Item LoadFromId(int id, bool forceRefresh, bool raiseEvent, bool useWowhead, string locale) { return LoadFromId(id, forceRefresh, raiseEvent, useWowhead, locale, "wotlk"); } //Changed www to wotlk
